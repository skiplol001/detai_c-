...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="sach-container">
        ...
        <asp:Panel ID="pnlEmpty" runat="server" Visible="false" Style="text-align: center; padding: 50px; color: #64748b;">
            <i class="fa-solid fa-box-open" style="font-size: 48px; margin-bottom: 15px; opacity: 0.3;"></i>
            <p>Hiện chưa có sách nào thuộc danh mục này.</p>
            <a href="danhsach.aspx" class="nav-link" style="display: inline-block; margin-top: 10px; color: var(--primary-color)">Xem tất cả sách</a>
        </asp:Panel>
